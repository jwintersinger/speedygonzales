...
function create_state_manager() {
  ...
  for(var i = 2; i < 7; i++) {
    sm.add_transition_prob(i.toString(), (i + 1).toString(), 0.80);
    sm.add_transition_prob(i.toString(), (i - 1).toString(), 0.08);
  }

  for(var i = 5; i <= 10; i++) {
    sm.add_transition_prob(i.toString(), 'attack', 0.12);
  }
  sm.add_transition_prob('attack', 'recover', 0.45);
  ...
  sm.add_transition_prob('7', '9', 0.1);
  sm.add_transition_prob('8', '9', 0.1);
  sm.add_transition_prob('8', '5', 0.4);
  sm.add_transition_prob('9', '5', 0.4);
  sm.add_transition_prob('9', '10', 0.1);
  sm.add_transition_prob('10', '4', 0.5);
